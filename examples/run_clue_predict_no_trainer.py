...
from gau_alpha import GAUAlphaForSequenceClassification, GAUAlphaTokenizerFast
...
def predict():
    ...
    tokenizer = GAUAlphaTokenizerFast.from_pretrained(args.model_name_or_path)
    model = GAUAlphaForSequenceClassification.from_pretrained(args.model_name_or_path)
    model.eval()
